...
const createHobby = () => {
    ...
    return (
        <div className="createEvent">
            ...
            <br/>
            <br/>
            <h1 className="note">NOTE: Du erstellst kein Event sondern ein Hobby (Unser altes Forschungsprojekt)</h1>
            <div className="infos">
                <div className="info">
                    <form className="content" onSubmit={handleSubmit}>
                        ...
                        <input className="title h3 c" placeholder="Title" type="text" autoFocus={true}
